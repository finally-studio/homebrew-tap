...
class Text2speech < Formula
  include Language::Python::Virtualenv

  desc "Convert text to speech using multiple providers like ElevenLabs and Gemini"
  homepage "https://github.com/finally-studio/text2speech"
  version "1.1.1"
  license "MIT"

  url "https://github.com/finally-studio/text2speech/releases/download/v1.1.1/text2speech.tar.gz",
      using: GitHubPrivateRepositoryReleaseDownloadStrategy
  sha256 "e874d9bab4b2c8e0d410f815a63ef34110d0d956e3e731f9b294d77de6863097"
  ...
  resource "elevenlabs" do
    url "https://files.pythonhosted.org/packages/8f/09/d945c793699a0df0de3f0038e3517c851093249a78f83e010e0a047d513f/elevenlabs-2.32.0.tar.gz"
    sha256 "b3f7d41c12a1054b0b0130555099b6b8011cf134239ecedb1d4286e96461fd36"
  end
  ...
  test do
    assert_match "usage: text2speech", shell_output("#{bin}/text2speech --help")
  end
end
